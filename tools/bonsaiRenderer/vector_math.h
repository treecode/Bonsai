...
/*
    ...
    This is borrowed from the NVIDIA CUTIL library and is not supported by NVIDIA.
...
{ int4 v; v.x = x; v.y = y; v.z=z; v.w=w; return v; }
...
{ uint4 v; v.x = x; v.y = y; v.z=z; v.w=w; return v; }
