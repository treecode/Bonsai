...
extern const char *particleVS, *simpleVS;
extern const char *particleSpherePS, *simplePS, *particlePS, *particleAAPS, *particleShadowPS;
...
extern const char *volnewPS, *volnewGS, *volnewVS, *volnew2texPS, *volnewCompositePS;
